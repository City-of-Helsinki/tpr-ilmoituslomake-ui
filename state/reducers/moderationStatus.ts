...
const moderationStatus = (state: ModerationStatusState | undefined, action: AnyAction): ModerationStatusState => {
  ...
  switch (action.type) {
    ...
    case SET_MODERATION_LABEL_STATUS: {
      console.log("SET_MODERATION_LABEL_STATUS", action.payload);
      return {
        ...state,
        moderationStatus: { ...state.moderationStatus, label_ids: action.payload },
      };
    }
    ...
    case SET_MODERATION_OTHER_CERTIFICATE_URL_STATUS: {
